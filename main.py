...
ic3= ['metro ', 'lotado'] 
ics=[ic,ic2,ic3]
dic0=['[c|C]arro', '[a|A]utom.*vel', '[v|V]e*.culo', '[v|V]iatura', '[c|C]aminh.*o', '[c|C]arreta', '[c|C]aminhonete', '[C|c]ombi', '[f|F]usca']
dic1=['[o|ô|O|Ô]nibus', '[l|L]ota[ç|c][a|ã]o', '[a|A]rticulado', '[b|B]iarticulado', '[c|C]oletivo', '[b|B]us$']
dic2=['[b|B]icicleta', '[B|b]+i(ke|ci)', '[c|C]iclovia', '[c|C]iclofaixa', '[b|B]iciclet[a|á]rio', 'paraciclo', 'pedalar', 'pedal']
dic3=['[m|M]etr[o|ô]']
